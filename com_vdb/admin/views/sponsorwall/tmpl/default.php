...
<form action="index.php" method="post" name="adminForm" id="adminForm">
    ...
    <div id="filter-bar" class="btn-toolbar">
        <div class="filter-search btn-group pull-left">
            ...
            <input placeholder="SEARCH IN TITLE" type="text" name="search" id="search" value="<?php echo $this->escape($this->lists['search']); ?>" title="<?php echo JText::_('COM_SPONSORWALL_SEARCH_WALL'); ?>" />
        </div>
    ...
    <table class="table table-striped" id="articleList">
        ...
        for($i = 0, $n = count($this->items); $i < $n; $i++)
        {
            ...
            $link = JRoute::_('index.php?option=com_sponsorwall&task=edit&cid[]=' . $row->id);
