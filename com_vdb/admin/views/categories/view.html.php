 ...
 * @subpackage Components
 */
class sponsorwallViewcategories extends JViewLegacy
{
    ...
    function display($tpl = null)
    {
        ...
        JSubMenuHelper::addEntry(JText::_('Categories'), 'index.php?option=com_sponsorwall&controller=categories', true);
        ...
        $filter_order_cat = $app->getUserStateFromRequest($option . 'filter_order_cat', 'filter_order_cat', 'c.ordering', 'cmd');
