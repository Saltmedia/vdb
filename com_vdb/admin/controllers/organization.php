...
class vdbControllerorganization extends JControllerLegacy
{
    ...
    function save()
    {
        ...
        if($model->store())
        {
            $msg = JText::_('Organization Category Saved!');
        }
        else
        {
            $msg = JText::_('Error Saving Organization Category');
        }

        // Check the table in so it can be edited.... we are done with it anyway
        $link = 'index.php?option=com_vdb&controller=organizations';
    ...
    function remove()
    {
        ...
        $this->setRedirect('index.php?option=com_vdb&controller=organizations', $msg);
    }
